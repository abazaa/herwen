...
redis:set(herwen.."getidstatus"..msg.chat_id_, "Simple")
...
redis:set(herwen..'lock:join:'..msg.chat_id_,true)
...
redis:del(herwen..'lock:join:'..msg.chat_id_)
return "*• ** أهلا عزيزي *"..msg.TheRankCmd.."*\n• ** تم فتح الدخول بالرابط \n*" 
end


local function iherwen(msg,MsgText)

Channel = redis:get(herwen..'setch') or katrenno
--JoinChannel
function is_JoinChannel(msg)
if redis:get(herwen..'joinchnl') then
...
redis:setex(herwen..'ExpireDate:'..msg.chat_id_, extime, true)
if not redis:get(herwen..'CheckExpire::'..msg.chat_id_) then 
redis:set(herwen..'CheckExpire::'..msg.chat_id_,true) end
sendMsg(msg.chat_id_,msg.id_,'💂🏻‍♀️│تم شحن الاشتراك الى `'..MsgText[2]..'` يوم   ... 👍🏿')
sendMsg(SUDO_ID,0,'💂🏻‍♀️│تم شحن الاشتراك الى `'..MsgText[2]..'` يوم   ... 👍🏿\n🕵🏼️‍♀️│في مجموعه  » »  '..redis:get(herwen..'group:name'..msg.chat_id_))
else
...
if not msg.SudoUser then return "♦️*│*هذا الامر يخص {المطور} فقط  \n💥" end
if MsgText[2] == '1' then
redis:setex(herwen..'ExpireDate:'..msg.chat_id_, 2592000, true)
if not redis:get(herwen..'CheckExpire::'..msg.chat_id_) then 
redis:set(herwen..'CheckExpire::'..msg.chat_id_,true) 
end
sendMsg(msg.chat_id_,msg.id_,'💂🏻‍♀️│تم تفعيل الاشتراك   👍🏿\n📆│ الاشتراك » `30 يوم`  *(شهر)*')
sendMsg(SUDO_ID,0,'💂🏻‍♀️│تم تفعيل الاشتراك  👍🏿\n📆│ الاشتراك » `30 يوم`  *(شهر)*')
end
if MsgText[2] == '2' then
redis:setex(herwen..'ExpireDate:'..msg.chat_id_,7776000,true)
if not redis:get(herwen..'CheckExpire::'..msg.chat_id_) then 
redis:set(herwen..'CheckExpire::'..msg.chat_id_,true) 
end
...
if MsgText[2] == '3' then
redis:set(herwen..'ExpireDate:'..msg.chat_id_,true)
if not redis:get(herwen..'CheckExpire::'..msg.chat_id_) then 
redis:set(herwen..'CheckExpire::'..msg.chat_id_,true) end
...
local check_time = redis:ttl(herwen..'ExpireDate:'..msg.chat_id_)
...
local GroupName = (redis:get(herwen..'group:name'..msg.chat_id_) or '')
redis:set(herwen..'linkGroup'..msg.chat_id_,(data.invite_link_ or ""))
...
users = redis:get(herwen..'user_names:'..v.user_id_) or v.user_id_
x = x + 1
...
if not msg.Director then return "• **هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
local Chek_Info = https.request('https://api.telegram.org/bot'..Token..'/getChatMember?chat_id='.. msg.chat_id_ ..'&user_id='.. herwen..'')
...
if not msg.Director and redis:get(herwen..'lock_pin'..msg.chat_id_) then
...
function(arg,data)
if data.ID == "Ok" then
redis:set(herwen..":MsgIDPin:"..msg.chat_id_,msg.reply_id)
...
if not msg.Admin then return "• **هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n" end
if not MsgText[2] and msg.reply_id then
if redis:get(herwen..'lock:kara:'..msg.chat_id_) == 'off' then
...
if redis:get(herwen..'lock:kara:'..msg.chat_id_) == 'on' then
...
local Admins = redis:scard(herwen..'admins:'..msg.chat_id_)
redis:del(herwen..'admins:'..msg.chat_id_)
local NumMDER = redis:scard(herwen..'owners:'..msg.chat_id_)
redis:del(herwen..'owners:'..msg.chat_id_)
local MMEZEN = redis:scard(herwen..'whitelist:'..msg.chat_id_)
redis:del(herwen..'whitelist:'..msg.chat_id_)
...
if not msg.Director then return "• **هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
if not redis:get(herwen..'ExCmdLink'..msg.chat_id_) then
local LinkGp = ExportLink(msg.chat_id_)
if LinkGp then
LinkGp = LinkGp.result
redis:set(herwen..'linkGroup'..msg.chat_id_,LinkGp)
redis:setex(herwen..'ExCmdLink'..msg.chat_id_,120,true)
...
if not msg.Director then return "• **هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
redis:setex(herwen..'linkGroup'..msg.sender_user_id_,300,true)
return '• عزيزي قم برسال الرابط الجديد ...🍂'
end

if MsgText[1] == "الرابط" then
if not redis:get(herwen..'linkGroup'..msg.chat_id_) then 
return "• ** اوه لا يوجد رابط .\n• **لانشاء رابط ارسل { `انشاء رابط` }\n" 
end
local GroupName = redis:get(herwen..'group:name'..msg.chat_id_)
local GroupLink = redis:get(herwen..'linkGroup'..msg.chat_id_)
...
local Text = "• رابـط الـمـجـمـوعه • \n"..Flter_Markdown(redis:get(herwen..'group:name'..msg.chat_id_)).." :\n\n["..GroupLink.."]\n"
...
redis:set(herwen..'flood'..msg.chat_id_,MsgText[2]) 
...
if not msg.Director then return "• **هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
local Mn3Word = redis:scard(herwen..':Filter_Word:'..msg.chat_id_)
if Mn3Word == 0 then 
return "• ** عذراً لا توجد كلمات ممنوعه ليتم حذفها" 
end
redis:del(herwen..':Filter_Word:'..msg.chat_id_)
...
redis:del(herwen..'rulse:msg'..msg.chat_id_)
...
if not msg.Director then return "• **هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
if not redis:get(herwen..'welcome:msg'..msg.chat_id_) then 
return "• ** اوه هنالك خطأ .\n• عذراً لا يوجد ترحيب ليتم مسحه ." 
end
redis:del(herwen..'welcome:msg'..msg.chat_id_)
...
local NumMnsha = redis:scard(herwen..':Hussain:'..msg.chat_id_)
redis:del(herwen..':Hussain:'..msg.chat_id_)
...
local NumMnsha = redis:scard(herwen..':MONSHA_BOT:'..msg.chat_id_)
if NumMnsha ==0 then 
return "عذرا لا يوجد منشئيين ليتم مسحهم \n!" 
end
redis:del(herwen..':MONSHA_BOT:'..msg.chat_id_)
...
redis:del(herwen..'banned:'..msg.chat_id_)
return "• **أهلا عزيزي "..msg.TheRankCmd.."   \n•  تم مسح {* "..#list.." *} من المحظورين  \n"
end

if MsgText[2] == 'المكتومين' then
if not msg.Director then return "• **هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
local MKTOMEN = redis:scard(herwen..'is_silent_users:'..msg.chat_id_)
if MKTOMEN ==0 then 
return "• ** لا يوجد مستخدمين مكتومين في المجموعه " 
end
redis:del(herwen..'is_silent_users:'..msg.chat_id_)
...
redis:del(herwen..'linkGroup'..msg.chat_id_)
...
if not msg.Creator then return "• **هذا الامر يخص {المطور,المنشئ} فقط  \n" end
redis:setex(herwen..'name:witting'..msg.sender_user_id_,300,true)
...
redis:setex(herwen..'photo:group'..msg.chat_id_..msg.sender_user_id_,300,true)
...
if not msg.Creator then return "• **هذا الامر يخص {المطور,المنشئ} فقط  \n" end
redis:setex(herwen..'about:witting'..msg.sender_user_id_,300,true) 
...
kick_user(v.user_id_,msg.chat_id_,function(arg,data)  
redis:srem(herwen..':MONSHA_BOT:'..msg.chat_id_,v.user_id_)
redis:srem(herwen..'whitelist:'..msg.chat_id_,v.user_id_)
redis:srem(herwen..'owners:'..msg.chat_id_,v.user_id_)
redis:srem(herwen..'admins:'..msg.chat_id_,v.user_id_)
end)
end
NumMem = NumMem + 1
...
if redis:get(herwen..'lock_id'..msg.chat_id_) then 
local msgs = redis:get(herwen..'msgs:'..msg.sender_user_id_..':'..msg.chat_id_) or 1
GetUserID(msg.sender_user_id_,function(arg,data)
if data.username_ then UserNameID = "@"..data.username_.."" else UserNameID = "" end
local points = redis:get(herwen..':User_Points:'..msg.chat_id_..msg.sender_user_id_)
if points and points ~= "0" then
nko = points
else
nko = '0'
end
local rfih = (redis:get(herwen..':edited:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local NumGha = (redis:get(herwen..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local Namei = FlterName(data.first_name_..' '..(data.last_name_ or ""),20)
GetPhotoUser(msg.sender_user_id_,function(arg, data)
if redis:get(herwen.."getidstatus"..msg.chat_id_) == "Photo" then
	if data.photos_[0] then 
		...
		sendPhoto(msg.chat_id_,msg.id_,data.photos_[0].sizes_[1].photo_.persistent_id_,'☆ NAME 𖤍    '..Namei..'     \n☆ USE 𖤓 '..UserNameID..' .\n☆ MSG 𖡼 '..msgs..' .\n☆ STA ❈ '..msg.TheRank..' .\n☆ iD 𖡗 '..msg.sender_user_id_..' .',dl_cb,nil)
		else
...
GetUserID(msg.sender_user_id_,function(arg,data)
local msgs = (redis:get(herwen..'msgs:'..msg.sender_user_id_..':'..msg.chat_id_) or 0)
local NumGha = (redis:get(herwen..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local photo = (redis:get(herwen..':photo:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local sticker = (redis:get(herwen..':sticker:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local voice = (redis:get(herwen..':voice:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local audio = (redis:get(herwen..':audio:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local animation = (redis:get(herwen..':animation:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local edited = (redis:get(herwen..':edited:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local video = (redis:get(herwen..':video:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
...
redis:del(herwen..'msgs:'..msg.sender_user_id_..':'..msg.chat_id_)
return "• **تم مسح {* "..msgs.." *} من رسائلك .\n"
end

if MsgText[1]== 'جهاتي' then
return '• **  عدد جهاتك المضافة‏‏ ⇜ ❪ '..(redis:get(herwen..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)..' ❫ \n.'
end

if MsgText[1] == 'مسح' and MsgText[2] == 'جهاتي'  then
local adduser = redis:get(herwen..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_) or 0
if adduser == 0 then  return "• **عذرا ليس لديك جهات لكي يتم مسحها" end
redis:del(herwen..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_) 
...
local points = redis:get(herwen..':User_Points:'..msg.chat_id_..msg.sender_user_id_) or 0
if points == 0 then  return "• **عذرا ليس لديك نقاط لكِ يتم مسحها" end
redis:del(herwen..':User_Points:'..msg.chat_id_..msg.sender_user_id_)
...
GetUserID(msg.sender_user_id_,function(arg,data)
local msgs = (redis:del(herwen..'msgs:'..msg.sender_user_id_..':'..msg.chat_id_) or 0)
local NumGha = (redis:del(herwen..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local photo = (redis:del(herwen..':photo:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local sticker = (redis:del(herwen..':sticker:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local voice = (redis:del(herwen..':voice:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local audio = (redis:del(herwen..':audio:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local animation = (redis:del(herwen..':animation:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local edited = (redis:del(herwen..':edited:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local video = (redis:del(herwen..':video:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
...
if not msg.Admin then return "• **هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n" end
redis:set(herwen..'welcom:witting'..msg.sender_user_id_,true) 
...
if not msg.Admin then return "• **هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n" end
if redis:get(herwen..'welcome:msg'..msg.chat_id_)  then
return Flter_Markdown(redis:get(herwen..'welcome:msg'..msg.chat_id_))
else 
return "• **أهلا عزيزي "..msg.TheRankCmd.."  \n• نورت المجموعه \n" 
end 
end
...
redis:setex(herwen..'welcom_ph:witting'..msg.sender_user_id_,300,true) 
...
local Photo_Weloame = redis:get(herwen..':WELCOME_BOT')
if Photo_Weloame then
sendPhoto(msg.chat_id_,msg.id_,Photo_Weloame,[[• اهلا انا بوت]]..redis:get(herwen..':NameBot:')..[[ .
...
redis:setex(herwen..'text_sudo:witting'..msg.sender_user_id_,1200,true) 
return '• حسننا عزيزي .\n• الان قم بارسال الكليشه \n' 
end

if MsgText[1] == "ضع شرط التفعيل" and MsgText[2] and MsgText[2]:match('^%d+$') then 
redis:set(herwen..':addnumberusers',MsgText[2]) 
return '• ** تم وضـع شـرط التفعيل البوت اذا كانت المجموعه‏‏ اكثر مـن *【'..MsgText[2]..'】* عضـو  .\n' 
end

if MsgText[1] == "شرط التفعيل" then 
return'• ** شـرط التفعيل البوت اذا كانت المجموعه‏‏ اكثر مـن *【'..redis:get(herwen..':addnumberusers')..'】* عضـو .\n' 
end 
end

if MsgText[1] == 'المجموعات' or MsgText[1] == "المجموعات 🌋" then
if not msg.SudoUser then return "• **هذا الامر يخص {المطور} فقط  \n" end
return '• ** عدد المجموعات المفعلة » `'..redis:scard(herwen..'group:ids')..'`  ➼' 
end

if MsgText[1] == "المشتركين" or MsgText[1] == "المشتركين Ⓜ" then
if not msg.SudoUser then return "• **هذا الامر يخص {المطور} فقط  \n" end
return '• **عدد المشتركين في البوت : `'..redis:scard(herwen..'users')..'` \n'
end
...
if not msg.SudoUser then return "• **هذا الامر يخص {المطور} فقط  \n" end
if redis:sismember(herwen..'group:ids',MsgText[2]) then
local name_gp = redis:get(herwen..'group:name'..MsgText[2])
...
return redis:get(herwen..":TEXT_SUDO") or '• لا توجد كليشه المطور .\n• يمكنك اضافه كليشه من خلال الامر\n       " `ضع كليشه المطور` " \n'
end

if MsgText[1] == "اذاعه عام بالتوجيه" or MsgText[1] == "اذاعه عام بالتوجيه 📣" then
if not msg.SudoUser then return"• **هذا الامر يخص {المطور} فقط  \n" end
if not msg.SudoBase and not redis:get(herwen..'lock_brod') then 
return "• ** الاذاعه مقفوله من قبل المطور الاساسي  ." 
end
redis:setex(herwen..'fwd:'..msg.sender_user_id_,300, true) 
...
redis:setex(herwen..'fwd:all'..msg.sender_user_id_,300, true) 
...
redis:setex(herwen..'fwd:pv'..msg.sender_user_id_,300, true) 
...
redis:setex(herwen..'fwd:groups'..msg.sender_user_id_,300, true) 
...
redis:del(herwen..'welcom:witting'..msg.sender_user_id_,
herwen..'rulse:witting'..msg.sender_user_id_,
herwen..'rulse:witting'..msg.sender_user_id_,
herwen..'name:witting'..msg.sender_user_id_,
herwen..'about:witting'..msg.sender_user_id_,
herwen..'fwd:all'..msg.sender_user_id_,
herwen..'fwd:pv'..msg.sender_user_id_,
herwen..'fwd:groups'..msg.sender_user_id_,
herwen..'namebot:witting'..msg.sender_user_id_,
herwen..'addrd_all:'..msg.sender_user_id_,
herwen..'delrd:'..msg.sender_user_id_,
herwen..":Witting_KleshaID"..msg.chat_id_..msg.sender_user_id_,
herwen..':prod_pin:'..msg.chat_id_..msg.sender_user_id_,
herwen..'addrd:'..msg.sender_user_id_,
herwen..'delrdall:'..msg.sender_user_id_,
herwen..":ForceSub:"..msg.sender_user_id_,
herwen..'text_sudo:witting'..msg.sender_user_id_,
herwen..'addrd:'..msg.chat_id_..msg.sender_user_id_,
herwen..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
...
if not msg.SudoBase then return "*│*هذا الامر يخص {المطور الاساسي} فقط  \n" end
local GetVerison = https.request( 'https://raw.githubusercontent.com/abazaa/HERWENFILE/master/GetVersion.txt' ) or 0
print(GetVerison.." > "..version)
if GetVerison > version then
UpdateSourceStart = true
sendMsg(msg.chat_id_,msg.id_,' *╿* يوجد تحديث جديد الان \n*╽* جاري تنزيل وتثبيت التحديث  ...' )
redis:set(herwen..":VERSION",GetVerison)
return false
else
...
return 'ٴ𐄬 اصدار سورس هرويين : *v'..version..'* \n'
end
...
sendMsg(msg.chat_id_,msg.id_,'• ** عذراً اسم الملف غير مدعوم للنظام او لا يتوافق مع سورس هرويين يرجاء جلب الملف الاصلي الذي قمت بسحبه وبدون تعديل ع الاسم\n')
end  
else
...
local inline = {{{text="• قناة‏‏ السورس أضغط هنا ",url="t.me/‏harweenn"}}}
send_key(msg.sender_user_id_,'  [• قناة سورس : هرويين](t.me/‏harweenn)',nil,inline,msg.id_)
return false
end

if (MsgText[1]== "الاحصائيات 💥" or MsgText[1]=="الاحصائيات") then
if not msg.SudoBase then return"• **هذا الامر يخص {المطور الاساسي} فقط  \n" end
return '• الاحصائيات . \n\n• **عدد المجموعات المفعله : '..redis:scard(herwen..'group:ids')..'\n• **عدد المشتركين في البوت : '..redis:scard(herwen..'users')..'\n'
end
---------------[End Function data] -----------------------
if MsgText[1]=="اضف رد عام" or MsgText[1]=="اضف رد عام ➕" then
if not msg.SudoBase then return"• **هذا الامر يخص {المطور الاساسي} فقط  \n" end
redis:setex(herwen..'addrd_all:'..msg.chat_id_..msg.sender_user_id_,300,true)
redis:del(herwen..'allreplay:'..msg.chat_id_..msg.sender_user_id_)
return "• حسننا الان ارسل كلمة الرد العام .\n"
end

if MsgText[1]== 'مسح' and MsgText[2]== 'الردود' then
if not msg.Director then return "• **هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
local names 	= redis:exists(herwen..'replay:'..msg.chat_id_)
local photo 	= redis:exists(herwen..'replay_photo:group:'..msg.chat_id_)
local voice 	= redis:exists(herwen..'replay_voice:group:'..msg.chat_id_)
local imation   = redis:exists(herwen..'replay_animation:group:'..msg.chat_id_)
local audio	 	= redis:exists(herwen..'replay_audio:group:'..msg.chat_id_)
local sticker 	= redis:exists(herwen..'replay_sticker:group:'..msg.chat_id_)
local video 	= redis:exists(herwen..'replay_video:group:'..msg.chat_id_)
if names or photo or voice or imation or audio or sticker or video then
redis:del(herwen..'replay:'..msg.chat_id_,herwen..'replay_photo:group:'..msg.chat_id_,herwen..'replay_voice:group:'..msg.chat_id_,
herwen..'replay_animation:group:'..msg.chat_id_,herwen..'replay_audio:group:'..msg.chat_id_,herwen..'replay_sticker:group:'..msg.chat_id_,herwen..'replay_video:group:'..msg.chat_id_)
...
local names 	= redis:exists(herwen..'replay:all')
local photo 	= redis:exists(herwen..'replay_photo:group:')
local voice 	= redis:exists(herwen..'replay_voice:group:')
local imation 	= redis:exists(herwen..'replay_animation:group:')
local audio 	= redis:exists(herwen..'replay_audio:group:')
local sticker 	= redis:exists(herwen..'replay_sticker:group:')
local video 	= redis:exists(herwen..'replay_video:group:')
if names or photo or voice or imation or audio or sticker or video then
redis:del(herwen..'replay:all',herwen..'replay_photo:group:',herwen..'replay_voice:group:',herwen..'replay_animation:group:',herwen..'replay_audio:group:',herwen..'replay_sticker:group:',herwen..'replay_video:group:')
...
if not msg.SudoBase then return"• **هذا الامر يخص {المطور الاساسي} فقط  \n" end
redis:set(herwen..'delrdall:'..msg.sender_user_id_,true) 
return "• حسننا عزيزي  .\n• الان ارسل الرد لمسحها من  المجموعات ."
end

if MsgText[1]== 'مسح' and MsgText[2]== 'رد' then
if not msg.Director then return "• **هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
redis:set(herwen..'delrd:'..msg.sender_user_id_,true)
return "• حسننا عزيزي  .\n• الان ارسل الرد لمسحها من  للمجموعه ."
end

if MsgText[1]== 'الردود' then
if not msg.Director then return "• *│*هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
local names  	= redis:hkeys(herwen..'replay:'..msg.chat_id_)
local photo 	= redis:hkeys(herwen..'replay_photo:group:'..msg.chat_id_)
local voice  	= redis:hkeys(herwen..'replay_voice:group:'..msg.chat_id_)
local imation 	= redis:hkeys(herwen..'replay_animation:group:'..msg.chat_id_)
local audio 	= redis:hkeys(herwen..'replay_audio:group:'..msg.chat_id_)
local sticker 	= redis:hkeys(herwen..'replay_sticker:group:'..msg.chat_id_)
local video 	= redis:hkeys(herwen..'replay_video:group:'..msg.chat_id_)
...
local names 	= redis:hkeys(herwen..'replay:all')
local photo 	= redis:hkeys(herwen..'replay_photo:group:')
local voice 	= redis:hkeys(herwen..'replay_voice:group:')
local imation 	= redis:hkeys(herwen..'replay_animation:group:')
local audio 	= redis:hkeys(herwen..'replay_audio:group:')
local sticker 	= redis:hkeys(herwen..'replay_sticker:group:')
local video 	= redis:hkeys(herwen..'replay_video:group:')
if #names==0 and #photo==0 and #voice==0 and #imation==0 and #audio==0 and #sticker==0 and #video==0 then 
return '• **لا يوجد ردود مضافه حاليا \n' 
end
local ii = 1
...
if not msg.Director then return "• **هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
redis:setex(herwen..'addrd:'..msg.chat_id_..msg.sender_user_id_,300,true) 
redis:del(herwen..'replay1'..msg.chat_id_..msg.sender_user_id_)
return "• حسننا , الان ارسل كلمه الرد \n"
end

if MsgText[1] == "ضع اسم للبوت" or MsgText[1]== 'ضع اسم للبوت ©' then
if not msg.SudoBase then return"• **هذا الامر يخص {المطور الاساسي} فقط  \n" end
redis:setex(herwen..'namebot:witting'..msg.sender_user_id_,300,true)
...
if not msg.Admin then return "• **هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n• " end
if not redis:get(herwen..'lave_me'..msg.chat_id_) then 
return "• **أهلا عزيزي "..msg.TheRankCmd.."\n• ** المغادره بالتاكيد تم تفعيلها\n✓" 
else 
redis:del(herwen..'lave_me'..msg.chat_id_) 
return "• **أهلا عزيزي "..msg.TheRankCmd.."\n• ** تم تفعيل المغادره \n✓" 
end 
end
if MsgText[1] == "تعطيل" and MsgText[2] == "اطردني" then
if not msg.Admin then return "• **هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n• " end
if redis:get(herwen..'lave_me'..msg.chat_id_) then 
return "• **أهلا عزيزي "..msg.TheRankCmd.."\n• ** المغادره من قبل البوت بالتأكيد معطله\n✓" 
else
redis:set(herwen..'lave_me'..msg.chat_id_,true)  
...
return [[
• [𝐣𝐨𝐤𝐞𝐫 𝐫𝐚𝐩 𓏢](https://t.me/jokerrap1)
𖤍𖤍𖤍𖤍𖤍𖤍
• [𝑯𝑨𝑹𝑾𝑬𝑵 𖡚℡](t.me/mhzon1)
𖤍𖤍𖤍𖤍𖤍𖤍
• [𝕊𝕆𝕌ℝℂ𝔼 ℍ𝔸ℝ𝕎𝔼ℕ 𖡥](t.me/harweenn)
]]
end
...
if not msg.SudoBase then return"• **هذا الامر يخص {المطور الاساسي} فقط  \n" end
local SubDel = redis:del(herwen..":UserNameChaneel")
if SubDel == 1 then
...
if redis:get(herwen..'welc'..msg.chat_id_) == 'on' then
...
local hash = herwen..'user_names:'..msg.sender_user_id_
redis:set(hash,info)
end
...
mmd = redis:get(herwen..'addcmd'..msg.chat_id_..msg.sender_user_id_)
if mmd then
redis:sadd(herwen..'CmDlist:'..msg.chat_id_,msg.text)
redis:hset(herwen..'CmD:'..msg.chat_id_,msg.text,mmd)
sendMsg(msg.chat_id_,msg.id_,'• اهلا عزيزي \n• تم تثبيت الامر الجديد\n✓')
redis:del(herwen..'addcmd'..msg.chat_id_..msg.sender_user_id_)
end

if Black:match('تغير امر (.*)') then
if not msg.Kara then return "• **هذا الامر يخص {المنشئ الاساسي,المطور,المطور الاساسي} فقط  \n" end
local cmd = Black:match('تغير امر (.*)') 
redis:setex(herwen..'addcmd'..msg.chat_id_..msg.sender_user_id_,120,cmd)
...
redis:hdel(herwen..'CmD:'..msg.chat_id_,cmd)
redis:srem(herwen..'CmDlist:'..msg.chat_id_,cmd)
sendMsg(msg.chat_id_,msg.id_,"• اهلا عزيزي\nالامر >"..cmd.."\n• تم مسحه من قائمه الاوامر\n")
end
if Black == 'مسح قائمه الاوامر' or Black == 'مسح قائمه الاوامر' then
if not msg.Kara then return "• **هذا الامر يخص {المنشئ الاساسي,المطور,المطور الاساسي} فقط  \n" end
redis:del(herwen..'CmD:'..msg.chat_id_)
redis:del(herwen..'CmDlist:'..msg.chat_id_)
sendMsg(msg.chat_id_,msg.id_,"• اهلا عزيزي تم مسح قائمه الاوامر")
end
if Black == "قائمه الاوامر" then
if not msg.Kara then return "• **هذا الامر يخص {المنشئ الاساسي,المطور,المطور الاساسي} فقط  \n" end
local CmDlist = redis:smembers(herwen..'CmDlist:'..msg.chat_id_)
local t = '• قائمه الاوامر : \n'
for k,v in pairs(CmDlist) do
mmdi = redis:hget(herwen..'CmD:'..msg.chat_id_,v)
t = t..k..") "..v.." > "..mmdi.."\n" 
end
if #CmDlist == 0 then
...
redis:set(herwen..'welc'..msg.chat_id_,'on')
end
end
if Text == 'welcome off' or Text == 'تعطيل الترحيب' then
if redis:get(herwen..'welc'..msg.chat_id_) == 'off' then
sendMsg(msg.chat_id_,msg.id_,'تم تعطيل الترحيب سابقا')
redis:set(herwen..'welc'..msg.chat_id_,'off')
redis:del(herwen..'welc'..msg.chat_id_,'on')
else
...
function tophoto(kara,herwen)   
if herwen.content_.ID == "MessageSticker" then        
local bd = herwen.content_.sticker_.sticker_.path_          
...
local msg_pv = tonumber(redis:get(herwen..'user:'..msg.sender_user_id_..':msgs') or 0)
if msg_pv > 5 then
redis:setex(herwen..':mute_pv:'..msg.sender_user_id_,18000,true)   
return sendMsg(msg.chat_id_,0,'*• * تم حظرك من البوت بسبب التكرار \n') 
end
redis:setex(herwen..'user:'..msg.sender_user_id_..':msgs',2,msg_pv+1)
end

if msg.text=="/start" then 

if msg.SudoBase then
local text = '- شكراً لك لإستخدام سورس هرويين\n- أنت المطور الاساسي هنا\n—————————\n\n- يمكنك الأن التحكم بأوامر البوت عن طريق لوحة التحكم بالبوت\nفقط انقر على الأمر الذي اريده‏'
local keyboard = {
...
redis:sadd(herwen..'users',msg.sender_user_id_)
if redis:get(herwen..'lock_service') then 
text = [[• أهلاً انا بوت   []]..redis:get(herwen..':NameBot:')..[[] 🗽
...
local MSG_ID = (redis:get(herwen.."USER_MSG_TWASEL"..FwdDate) or 1)
if msg.text then
...
if not redis:get(herwen..'lock_twasel') then
...
redis:setex(herwen.."USER_MSG_TWASEL"..msg.date_,43200,msg.id_)
...
--====================== Reply Only Group ====================================
if redis:get(herwen..'addrd:'..msg.chat_id_..msg.sender_user_id_) and redis:get(herwen..'replay1'..msg.chat_id_..msg.sender_user_id_) then
local klma = redis:get(herwen..'replay1'..msg.chat_id_..msg.sender_user_id_)
if msg.text then 
redis:hset(herwen..'replay:'..msg.chat_id_,klma,Flter_Markdown(msg.text))
redis:del(herwen..'addrd:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'(['..klma..'])\n• تم اضافت الرد . \n-')
elseif msg.photo then 
redis:hset(herwen..'replay_photo:group:'..msg.chat_id_,klma,photo_id)
redis:del(herwen..'addrd:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'• تم اضافه صوره للرد بنجاح\n• يمكنك ارسال ❴ ['..klma..'] ❵ لأظهار الصوره الاتيه ')
elseif msg.voice then
redis:hset(herwen..'replay_voice:group:'..msg.chat_id_,klma,voice_id)
redis:del(herwen..'addrd:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'• تم اضافه بصمه صوت للرد بنجاح\n• يمكنك ارسال ❴ ['..klma..'] ❵ لسماع البصمه الاتيه ')
elseif msg.animation then
redis:hset(herwen..'replay_animation:group:'..msg.chat_id_,klma,animation_id)
redis:del(herwen..'addrd:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'• تم اضافه متحركه للرد بنجاح\n• يمكنك ارسال ❴ ['..klma..'] ❵ لأظهار الصوره الاتيه ')
elseif msg.video then
redis:hset(herwen..'replay_video:group:'..msg.chat_id_,klma,video_id)
redis:del(herwen..'addrd:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'• تم اضافه فيديو للرد بنجاح\n• يمكنك ارسال ❴ ['..klma..'] ❵ لأظهار الفيديو الاتي ')
elseif msg.audio then
redis:hset(herwen..'replay_audio:group:'..msg.chat_id_,klma,audio_id)
redis:del(herwen..'addrd:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'• تم اضافه للصوت للرد بنجاح\n• يمكنك ارسال ❴ ['..klma..'] ❵ لأظهار الصوت الاتي ')
elseif msg.sticker then
redis:hset(herwen..'replay_sticker:group:'..msg.chat_id_,klma,sticker_id)
redis:del(herwen..'addrd:'..msg.chat_id_..msg.sender_user_id_)
...
--====================== Reply All Groups =====================================
if redis:get(herwen..'addrd_all:'..msg.chat_id_..msg.sender_user_id_) and redis:get(herwen..'allreplay:'..msg.chat_id_..msg.sender_user_id_) then
local klma = redis:get(herwen..'allreplay:'..msg.chat_id_..msg.sender_user_id_)
if msg.text then
redis:hset(herwen..'replay:all',klma,Flter_Markdown(msg.text))
redis:del(herwen..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'(['..klma..'])\n  • تم اضافت الرد لكل المجموعات . ')
elseif msg.photo then 
redis:hset(herwen..'replay_photo:group:',klma,photo_id)
redis:del(herwen..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'• تم اضافه صوره للرد العام\n• يمكنك ارسال ❴ ['..klma..'] ❵ لأظهار الصوره الاتيه ')
elseif msg.voice then
redis:hset(herwen..'replay_voice:group:',klma,voice_id)
redis:del(herwen..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'• تم اضافه بصمه صوت للرد العام\n• يمكنك ارسال ❴ ['..klma..'] ❵ لسماع البصمه الاتيه ')
elseif msg.animation then
redis:hset(herwen..'replay_animation:group:',klma,animation_id)
redis:del(herwen..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'• تم اضافه متحركه للرد العام\n• يمكنك ارسال ❴ ['..klma..'] ❵ لأظهار الصوره الاتيه ')
elseif msg.video then
redis:hset(herwen..'replay_video:group:',klma,video_id)
redis:del(herwen..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'• تم اضافه فيديو للرد العام\n• يمكنك ارسال ❴ ['..klma..'] ❵لأظهار الفيديو الاتي ')
elseif msg.audio then
redis:hset(herwen..'replay_audio:group:',klma,audio_id)
redis:del(herwen..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'• تم اضافه للصوت للرد العام\n• يمكنك ارسال ❴ ['..klma..'] ❵ لأظهار الصوت الاتي ')
elseif msg.sticker then
redis:hset(herwen..'replay_sticker:group:',klma,sticker_id)
redis:del(herwen..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
...
if redis:get(herwen..":ForceSub:"..msg.sender_user_id_) then
if msg.text:match("^@[%a%d_]+$") then
redis:del(herwen..":ForceSub:"..msg.sender_user_id_)
...
redis:set(herwen..":UserNameChaneel",msg.text)
...
if redis:get(herwen..'namebot:witting'..msg.sender_user_id_) then --- استقبال اسم البوت 
redis:del(herwen..'namebot:witting'..msg.sender_user_id_)
redis:set(herwen..':NameBot:',msg.text)
Start_Bot() 
sendMsg(msg.chat_id_,msg.id_,"• تم تغير اسم البوت  .\n• الان اسمه "..Flter_Markdown(msg.text).." \n")
return false
end

if redis:get(herwen..'addrd_all:'..msg.chat_id_..msg.sender_user_id_) then -- استقبال الرد لكل المجموعات
if not redis:get(herwen..'allreplay:'..msg.chat_id_..msg.sender_user_id_) then -- استقبال كلمه الرد لكل المجموعات
redis:hdel(herwen..'replay_photo:group:',msg.text)
redis:hdel(herwen..'replay_voice:group:',msg.text)
redis:hdel(herwen..'replay_animation:group:',msg.text)
redis:hdel(herwen..'replay_audio:group:',msg.text)
redis:hdel(herwen..'replay_sticker:group:',msg.text)
redis:hdel(herwen..'replay_video:group:',msg.text)
redis:setex(herwen..'allreplay:'..msg.chat_id_..msg.sender_user_id_,300,msg.text)
return sendMsg(msg.chat_id_,msg.id_,"• جيد , يمكنك الان ارسال جوا ب الردالعام \n• [[ نص,صوره,فيديو,متحركه,بصمه,اغنيه ]]\n")
end
end

if redis:get(herwen..'delrdall:'..msg.sender_user_id_) then
redis:del(herwen..'delrdall:'..msg.sender_user_id_)
local names = redis:hget(herwen..'replay:all',msg.text)
local photo =redis:hget(herwen..'replay_photo:group:',msg.text)
local voice = redis:hget(herwen..'replay_voice:group:',msg.text)
local animation = redis:hget(herwen..'replay_animation:group:',msg.text)
local audio = redis:hget(herwen..'replay_audio:group:',msg.text)
local sticker = redis:hget(herwen..'replay_sticker:group:',msg.text)
local video = redis:hget(herwen..'replay_video:group:',msg.text)
if not (names or photo or voice or animation or audio or sticker or video) then
return sendMsg(msg.chat_id_,msg.id_,'• **هذا الرد ليس مضاف في قائمه الردود .')
else
redis:hdel(herwen..'replay:all',msg.text)
redis:hdel(herwen..'replay_photo:group:',msg.text)
redis:hdel(herwen..'replay_voice:group:',msg.text)
redis:hdel(herwen..'replay_audio:group:',msg.text)
redis:hdel(herwen..'replay_animation:group:',msg.text)
...
if redis:get(herwen..'text_sudo:witting'..msg.sender_user_id_) then -- استقبال كليشه المطور
redis:del(herwen..'text_sudo:witting'..msg.sender_user_id_) 
redis:set(herwen..':TEXT_SUDO',Flter_Markdown(msg.text))
return sendMsg(msg.chat_id_,msg.id_, "• ** تم وضع الكليشه بنجاح كلاتي .\n\n*{*  "..Flter_Markdown(msg.text).."  *}*\n")
end
if redis:get(herwen..'welcom:witting'..msg.sender_user_id_) then -- استقبال كليشه الترحيب
redis:del(herwen..'welcom:witting'..msg.sender_user_id_) 
redis:set(herwen..'welcome:msg'..msg.chat_id_,msg.text)
return sendMsg(msg.chat_id_,msg.id_,"• ** تم وضع الترحيب بنجاح كلاتي .\n" )
end
if redis:get(herwen..'rulse:witting'..msg.sender_user_id_) then --- استقبال القوانين
redis:del(herwen..'rulse:witting'..msg.sender_user_id_) 
redis:set(herwen..'rulse:msg'..msg.chat_id_,Flter_Markdown(msg.text)) 
return sendMsg(msg.chat_id_,msg.id_,'• ** مرحبآ عزيزي\n• تم حفظ القوانين بنجاح .\n• ارسل [[ القوانين ]] لعرضها \n')
end
if redis:get(herwen..'name:witting'..msg.sender_user_id_) then --- استقبال الاسم
redis:del(herwen..'name:witting'..msg.sender_user_id_) 
tdcli_function({ID= "ChangeChatTitle",chat_id_=msg.chat_id_,title_=msg.text},dl_cb,nil)
end
if redis:get(herwen..'linkGroup'..msg.sender_user_id_,link) then --- استقبال الرابط
redis:del(herwen..'linkGroup'..msg.sender_user_id_,link) 
redis:set(herwen..'linkGroup'..msg.chat_id_,Flter_Markdown(msg.text)) 
return sendMsg(msg.chat_id_,msg.id_,'• تم وضع الرابط الجديد بنجاح .. 🍂')
end
if redis:get(herwen..'about:witting'..msg.sender_user_id_) then --- استقبال الوصف
redis:del(herwen..'about:witting'..msg.sender_user_id_) 
...
if redis:get(herwen..'fwd:all'..msg.sender_user_id_) then ---- استقبال رساله الاذاعه عام
redis:del(herwen..'fwd:all'..msg.sender_user_id_)
local pv = redis:smembers(herwen..'users')  
local groups = redis:smembers(herwen..'group:ids')
...
if redis:get(herwen..'fwd:pv'..msg.sender_user_id_) then ---- استقبال رساله الاذاعه خاص
redis:del(herwen..'fwd:pv'..msg.sender_user_id_)
local pv = redis:smembers(herwen..'users')
if #pv >= 300 then
...
if redis:get(herwen..'fwd:groups'..msg.sender_user_id_) then ---- استقبال رساله الاذاعه خاص
redis:del(herwen..'fwd:groups'..msg.sender_user_id_)
local groups = redis:smembers(herwen..'group:ids')
if #groups >= 300 then
...
if msg.adduser and msg.adduser == our_id and redis:get(herwen..':WELCOME_BOT') then
sendPhoto(msg.chat_id_,msg.id_,redis:get(herwen..':WELCOME_BOT'),[[•أهلاً انا بوت ]]..redis:get(herwen..':NameBot:')..[[
• أختصاصي حماية‌‏ المجموعات
• مـن السبام والتوجيه‌‏ والتكرار والخ...
...
if msg.forward_info and redis:get(herwen..'fwd:'..msg.sender_user_id_) then
redis:del(herwen..'fwd:'..msg.sender_user_id_)
local pv = redis:smembers(herwen..'users')
local groups = redis:smembers(herwen..'group:ids')
local allgp =  #pv + #groups
if allgp == 500 then
...
if msg.content_.ID == "MessagePhoto" and redis:get(herwen..'welcom_ph:witting'..msg.sender_user_id_) then
redis:del(herwen..'welcom_ph:witting'..msg.sender_user_id_)
if msg.content_.photo_.sizes_[3] then 
photo_id = msg.content_.photo_.sizes_[3].photo_.persistent_id_
else 
photo_id = msg.content_.photo_.sizes_[0].photo_.persistent_id_
end
redis:set(herwen..':WELCOME_BOT',photo_id)
return sendMsg(msg.chat_id_,msg.id_,'• تم تغيير صوره‏‏ الترحيب للبوت .\n')
end 

if msg.content_.ID == "MessagePhoto" and msg.type == "channel" and msg.GroupActive then
if redis:get(herwen..'photo:group'..msg.chat_id_..msg.sender_user_id_) then
redis:del(herwen..'photo:group'..msg.chat_id_..msg.sender_user_id_)
if msg.content_.photo_.sizes_[3] then 
photo_id = msg.content_.photo_.sizes_[3].photo_.persistent_id_
else 
photo_id = msg.content_.photo_.sizes_[0].photo_.persistent_id_
...
if redis:get(herwen..'addrd:'..msg.chat_id_..msg.sender_user_id_) then -- استقبال الرد للمجموعه فقط

if not redis:get(herwen..'replay1'..msg.chat_id_..msg.sender_user_id_) then  -- كلمه الرد
redis:hdel(herwen..'replay:'..msg.chat_id_,msg.text)
redis:hdel(herwen..'replay_photo:group:'..msg.chat_id_,msg.text)
redis:hdel(herwen..'replay_voice:group:'..msg.chat_id_,msg.text)
redis:hdel(herwen..'replay_animation:group:'..msg.chat_id_,msg.text)
redis:hdel(herwen..'replay_audio:group:'..msg.chat_id_,msg.text)
redis:hdel(herwen..'replay_sticker:group:'..msg.chat_id_,msg.text)
redis:hdel(herwen..'replay_video:group:'..msg.chat_id_,msg.text)
redis:setex(herwen..'replay1'..msg.chat_id_..msg.sender_user_id_,300,msg.text)
return sendMsg(msg.chat_id_,msg.id_,"• جيد , يمكنك الان ارسال جواب الرد \n• [[ نص,صوره,فيديو,متحركه,بصمه,اغنيه ]]\n")
end
end

if redis:get(herwen..'delrd:'..msg.sender_user_id_) then
redis:del(herwen..'delrd:'..msg.sender_user_id_)
local names 	= redis:hget(herwen..'replay:'..msg.chat_id_,msg.text)
local photo 	= redis:hget(herwen..'replay_photo:group:'..msg.chat_id_,msg.text)
local voice 	= redis:hget(herwen..'replay_voice:group:'..msg.chat_id_,msg.text)
local animation = redis:hget(herwen..'replay_animation:group:'..msg.chat_id_,msg.text)
local audio 	= redis:hget(herwen..'replay_audio:group:'..msg.chat_id_,msg.text)
local sticker 	= redis:hget(herwen..'replay_sticker:group:'..msg.chat_id_,msg.text)
local video 	= redis:hget(herwen..'replay_video:group:'..msg.chat_id_,msg.text)
if not (names or photo or voice or animation or audio or sticker or video) then
return sendMsg(msg.chat_id_,msg.id_,'• **هذا الرد ليس مضاف في قائمه الردود .')
else
redis:hdel(herwen..'replay:'..msg.chat_id_,msg.text)
...
if msg.pinned then
print(" -- pinned -- ")
local msg_pin_id = redis:get(herwen..":MsgIDPin:"..msg.chat_id_)
if not msg.Director and redis:get(herwen..'lock_pin'..msg.chat_id_) then
if msg_pin_id then
...
redis:set(herwen..":MsgIDPin:"..msg.chat_id_,msg.id_)
end
...
if redis:get(herwen..'welcome:get'..msg.chat_id_) then 
if not msg.adduserType then
GetUserID(msg.sender_user_id_,function(arg,data)  
welcome = (redis:get(herwen..'welcome:msg'..msg.chat_id_) or "• اهلاً عزيزي {الاسم}\n• معرفك » {المعرف}\n{القوانين}\n\nالرجاء الالتزام بالقوانين\nـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ\n• اسم القروب » {المجموعه}")
if welcome then
rules = (redis:get(herwen..'rulse:msg'..msg.chat_id_) or "• مرحباً عزيري القوانين كلاتي .\n• ممنوع نشر الروابط\n• ممنوع التكلم او نشر صور اباحيه\n• ممنوع  اعاده توجيه\n• ممنوع التكلم بالسياسة\n• الرجاء احترام المدراء والادمنيه .\n")
welcome = welcome:gsub("{القوانين}", rules)
if data.username_ then UserName = '@'..data.username_ else UserName = '< لا يوجد معرف >' end
welcome = welcome:gsub("{المجموعه}",Flter_Markdown((redis:get(herwen..'group:name'..msg.chat_id_) or '')))
...
welcome = (redis:get(herwen..'welcome:msg'..msg.chat_id_) or "• اهلن بك عزيزي {الاسم}\n• معرفك » {المعرف}\n{القوانين}\n\nالرجاء الالتزام بالقوانين\nـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ\n• اسم القروب » {المجموعه}")
if welcome then
rules = (redis:get(herwen..'rulse:msg'..msg.chat_id_) or "• مرحباً عزيري القوانين كلاتي .\n• ممنوع نشر الروابط\n• ممنوع التكلم او نشر صور اباحيه\n• ممنوع  اعاده توجيه\n• ممنوع التكلم بالسياسة\n• الرجاء احترام المدراء والادمنيه\n")
welcome = welcome:gsub("{القوانين}", rules)
...
--------------------------------------------
if msg.adduser and redis:get(herwen..'welcome:get'..msg.chat_id_) then
local adduserx = tonumber(redis:get(herwen..'user:'..msg.sender_user_id_..':msgs') or 0)
if adduserx > 3 then 
redis:del(herwen..'welcome:get'..msg.chat_id_)
end
redis:setex(herwen..'user:'..msg.sender_user_id_..':msgs',3,adduserx+1)
end

if not msg.Admin and not msg.Special and not (msg.adduser or msg.joinuser or msg.deluser ) then -- للاعضاء فقط   

if not msg.forward_info and redis:get(herwen..'lock_flood'..msg.chat_id_)  then
local msgs = (redis:get(herwen..'user:'..msg.sender_user_id_..':msgs') or 0)
local NUM_MSG_herwen = (redis:get(herwen..'num_msg_herwen'..msg.chat_id_) or 5)
if tonumber(msgs) > tonumber(NUM_MSG_herwen) then 
GetUserID(msg.sender_user_id_,function(arg,datau)
Restrict(msg.chat_id_,msg.sender_user_id_,1)
redis:setex(herwen..'sender:'..msg.sender_user_id_..':flood',30,true)
if datau.username_ then USERNAME = '@'..datau.username_ else USERNAME = FlterName(datau.first_name_..' '..(datau.last_name_ or "")) end
local USERCAR = utf8.len(USERNAME)
SendMention(msg.chat_id_,datau.id_,msg.id_,"• العضو » "..USERNAME.."\n• قمـت بتكرار اكثر مـن "..NUM_MSG_herwen.." رسالة‌‏ , لذا تم تقييدك مـن المجموعه‌\n",12,USERCAR) 
return false
end)
end 
redis:setex(herwen..'user:'..msg.sender_user_id_..':msgs',2,msgs+1)
end
...
if redis:get(herwen..'mute_forward'..msg.chat_id_) then -- قفل التوجيه
...
if redis:get(herwen..'lock_woring'..msg.chat_id_) and not redis:get(herwen..':User_Fwd_Msg:'..msg.sender_user_id_..':flood') then
GetUserID(msg.sender_user_id_,function(arg,data)
...
return redis:setex(herwen..':User_Fwd_Msg:'..msg.sender_user_id_..':flood',15,true)
end,nil)
end
end)
return false
elseif redis:get(herwen..':tqeed_fwd:'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
elseif tonumber(msg.via_bot_user_id_) ~= 0 and redis:get(herwen..'mute_inline'..msg.chat_id_) then -- قفل الانلاين
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
print("\27[1;31m Msg Del becuse send inline \27[0m")
if data.ID == "Error" and data.code_ == 6 then
return sendMsg(msg.chat_id_,msg.id_,'• ** لا يمكنني مسح الرساله المخالفه .\n• ** لست مشرف او ليس لدي صلاحيه  الحذف \n')    
end
if redis:get(herwen..'lock_woring'..msg.chat_id_) then
GetUserID(msg.sender_user_id_,function(arg,data)
...
if utf8.len(msg.text) > 500 and redis:get(herwen..'lock_spam'..msg.chat_id_) then -- قفل الكليشه 
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
and redis:get(herwen..':tqeed_link:'..msg.chat_id_)  then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
and redis:get(herwen..'lock_link'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif (msg.text:match("[Hh][Tt][Tt][Pp][Ss]://") or msg.text:match("[Hh][Tt][Tt][Pp]://") or msg.text:match("[Ww][Ww][Ww].") or msg.text:match(".[Cc][Oo][Mm]") or msg.text:match(".[Tt][Kk]") or msg.text:match(".[Mm][Ll]") or msg.text:match(".[Oo][Rr][Gg]")) and redis:get(herwen..'lock_webpage'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.text:match("#[%a%d_]+") and redis:get(herwen..'lock_tag'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.text:match("@[%a%d_]+")  and redis:get(herwen..'lock_username'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif not msg.textEntityTypeBold and (msg.textEntityTypeBold or msg.textEntityTypeItalic) and redis:get(herwen..'lock_markdown'..msg.chat_id_) then 
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.textEntityTypeTextUrl and redis:get(herwen..'lock_webpage'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
elseif msg.edited and redis:get(herwen..'lock_edit'..msg.chat_id_) then -- قفل التعديل
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
elseif msg.content_.ID == "MessageUnsupported" and redis:get(herwen..'mute_video'..msg.chat_id_) then -- قفل الفيديو
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.photo then
if redis:get(herwen..'mute_photo'..msg.chat_id_)  then -- قفل الصور
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif redis:get(herwen..':tqeed_photo:'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
elseif msg.video then
if redis:get(herwen..'mute_video'..msg.chat_id_) then -- قفل الفيديو
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif redis:get(herwen..':tqeed_video:'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
elseif msg.document and redis:get(herwen..'mute_document'..msg.chat_id_) then -- قفل الملفات
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.sticker and redis:get(herwen..'mute_sticker'..msg.chat_id_) then --قفل الملصقات
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.animation then
if redis:get(herwen..'mute_gif'..msg.chat_id_) then -- قفل المتحركه
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif redis:get(herwen..':tqeed_gif:'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
elseif msg.contact and redis:get(herwen..'mute_contact'..msg.chat_id_) then -- قفل الجهات
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.location and redis:get(herwen..'mute_location'..msg.chat_id_) then -- قفل الموقع
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.voice and redis:get(herwen..'mute_voice'..msg.chat_id_) then -- قفل البصمات
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.game and redis:get(herwen..'mute_game'..msg.chat_id_) then -- قفل الالعاب
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.audio and redis:get(herwen..'mute_audio'..msg.chat_id_) then -- قفل الصوت
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.replyMarkupInlineKeyboard and redis:get(herwen..'mute_keyboard'..msg.chat_id_) then -- كيبورد
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
and redis:get(herwen..'lock_webpage'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.content_.caption_:match("@[%a%d_]+") and redis:get(herwen..'lock_username'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
if msg.text and redis:get(herwen..'replay'..msg.chat_id_) then

local Replay = false

 Replay = redis:hget(herwen..'replay:all',msg.text)
if Replay then
sendMsg(msg.chat_id_,msg.id_,Replay)
return false
end

 Replay = redis:hget(herwen..'replay:'..msg.chat_id_,msg.text)
if Replay then 
 sendMsg(msg.chat_id_,msg.id_,Replay) 
return false
end
 Replay = redis:hget(herwen..'replay_photo:group:',msg.text)
if Replay then 
 sendPhoto(msg.chat_id_,msg.id_,Replay)  
return false
end

Replay = redis:hget(herwen..'replay_voice:group:',msg.text)
if Replay then 
 sendVoice(msg.chat_id_,msg.id_,Replay)
return false
end

Replay = redis:hget(herwen..'replay_animation:group:',msg.text)
if Replay then 
 sendAnimation(msg.chat_id_,msg.id_,Replay)  
return false
end

Replay = redis:hget(herwen..'replay_audio:group:',msg.text)
if Replay then 
 sendAudio(msg.chat_id_,msg.id_,Replay)  
return false
end

Replay = redis:hget(herwen..'replay_sticker:group:',msg.text)
if Replay then 
 sendSticker(msg.chat_id_,msg.id_,Replay)  
return false
end

Replay = redis:hget(herwen..'replay_video:group:',msg.text)
if Replay then 
print("0000000000000") 
...
Replay = redis:hget(herwen..'replay_photo:group:'..msg.chat_id_,msg.text)
if Replay then 
 sendPhoto(msg.chat_id_,msg.id_,Replay)  
return false
end

Replay = redis:hget(herwen..'replay_voice:group:'..msg.chat_id_,msg.text)
if Replay then 
 sendVoice(msg.chat_id_,msg.id_,Replay)
return false
end

Replay = redis:hget(herwen..'replay_animation:group:'..msg.chat_id_,msg.text)
if Replay then 
 sendAnimation(msg.chat_id_,msg.id_,Replay)  
return false
end

Replay = redis:hget(herwen..'replay_audio:group:'..msg.chat_id_,msg.text)
if Replay then 
 sendAudio(msg.chat_id_,msg.id_,Replay)  
return false
end

Replay = redis:hget(herwen..'replay_sticker:group:'..msg.chat_id_,msg.text)
if Replay then 
 sendSticker(msg.chat_id_,msg.id_,Replay)  
return false
end

Replay = redis:hget(herwen..'replay_video:group:'..msg.chat_id_,msg.text)
if Replay then 
 sendVideo(msg.chat_id_,msg.id_,Replay)
return false
end
...
elseif Text== "اباظه" or Text== "باسل اباظه" then return  sendMsg(msg.chat_id_,msg.id_,"[مطور جميع السورسات ✮](https://t.me/XB_1B)")
elseif Text== "ميرا" or Text== "mira" then return  sendMsg(msg.chat_id_,msg.id_,"[بنت هرويين♡](https://t.me/The0Queen17)")
elseif Text== "جوكر" or Text== "جوكر راب" then return  sendMsg(msg.chat_id_,msg.id_,"[مالك السورس](https://t.me/jokerrap1)")
elseif Text== "كارفهم" or Text== "هروين كارفهم" then return  sendMsg(msg.chat_id_,msg.id_,"[مالك السورس](https://t.me/mhzon1)")
...
‏
  ...
  --=====================================
  elseif Text== "باسل" or Text== "جوكر" or Text=="هروين" then
if msg.SudoUser then  
return sendMsg(msg.chat_id_,msg.id_,"[مطور السورس ♕](https://t.me/harweenn) ")
...
if not redis:get('kar') then
  ...
  if redis:get(herwen..'CheckExpire::'..msg.chat_id_) then
  local ExpireDate = redis:ttl(herwen..'ExpireDate:'..msg.chat_id_)
  if not ExpireDate and not msg.SudoUser then
  rem_data_group(msg.chat_id_)
  sendMsg(SUDO_ID,0,'• انتهى الاشتراك في احد المجموعات .\n• المجموعه : '..FlterName(redis:get(herwen..'group:name'..msg.chat_id_))..'.\n• ايدي : '..msg.chat_id_)
  sendMsg(msg.chat_id_,0,'• انتهى الاشتراك البوت.\n• سوف اغادر المجموعه فرصه سعيده .\n• او راسل المطور للتجديد '..SUDO_USER..' 🍃')
  return StatusLeft(msg.chat_id_,our_id)
  else
  local DaysEx = (redis:ttl(herwen..'ExpireDate:'..msg.chat_id_) / 86400)
