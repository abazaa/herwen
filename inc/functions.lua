...
─────▀██▀─────
│harwen ‿ @mhzon
تم تطوير وبرمجة السورس من قبل  هروين كارفهم
│@mhzon1 ‿ @mhzon1 
#-------------------------------------------------------------------
]]
...
if redis:get(herwen..'group:add'..msg.chat_id_) then  return '• **المجموعة تم تفعيلها مُسبقاً . ' end
...
if not redis:get(herwen..'group:add'..msg.chat_id_) then return '** المجموعه تم تعطيلها مُسبقاً .' end  
...
return sendMsg(ChatID,MsgID,"• **لا يمكنك طرد المطور الاساسي\n")
elseif UserID == 995964411 then 
return sendMsg(ChatID,MsgID,"• **لا يمكنك طر د مطور السورس\n")  
elseif redis:sismember(herwen..':SUDO_BOT:',UserID) then 
return sendMsg(ChatID,MsgID,"• **لا يمكنك طرد المطور\n") 
elseif
...
if cmd == "dn_sudo" then
if not redis:sismember(herwen..':SUDO_BOT:',UserID) then return sendMsg(ChatID,MsgID,'• **العضو » '..USERNAME..' \n• ** الايدي » (`'..UserID..'`)\n• **انه بالتأكيد ليس مطور \n') end
redis:srem(herwen..':SUDO_BOT:',UserID) 
return SendMention(ChatID,UserID,MsgID,'• العضو » ❪ '..USERNAME..' ❫\n• الايدي » ❪ '..UserID..' ❫\n• تم تنزيله من المطور \n',17,USERCAR) 
end
