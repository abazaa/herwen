...
return 'ٴ𐄬 اصدار سورس هروين: *v'..version..'* \n'
end
...
sendMsg(msg.chat_id_,msg.id_,'• ** عذراً اسم الملف غير مدعوم للنظام او لا يتوافق مع سورس ههروينن يرجاء جلب الملف الاصلي الذي قمت بسحبه وبدون تعديل ع الاسم\n')
end  
else
...
send_key(msg.sender_user_id_,'  [• قناة سورس : ههروينن](t.me/‏harweenn)',nil,inline,msg.id_)
return false
end
...
return [[
• [hrwen chanel .](https://t.me/ISSSM)
• [ههروينن كارفهم.](t.me/mhzon1) 
• [جوكر راب](t.me/gokerrap1) 
• [Source harwen](https://t.me/harween)
]]
end
...
return 'ٴ𐄬 **عدد سحكاتك ⇜ ❪ '..(redis:get(herwen..':edited:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)..' ❫ \n'
end
...
elseif Text== "ههروينن كارفهم" or Text== "ههروينن كارفهم" then return  sendMsg(msg.chat_id_,msg.id_,"[أعيناكَ حُباً أم الحُب شيئاً من عيناك .](https://t.me/mhzon1)")
elseif Text== "باسل" or Text== "باسل اباظه" or Text== "اباظه" then return  sendMsg(msg.chat_id_,msg.id_,"[ملك التلجرام ♕](https://t.me/xb_1b)")
elseif Text== "ميرا" or Text== "رهف" then return  sendMsg(msg.chat_id_,msg.id_,"[هيِ‌ملاكِ‌وحارسِ‌ورفيقتي‌وحبيبً‌وضلعي .](https://t.me/TlIlIl5)")
...
‏
  ...
  --=====================================
  elseif Text== "هروين" or Text== "جوكر راب" or Text=="ههروينن" then
